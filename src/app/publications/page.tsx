                        ...
                        <section>
                            ...
                            <div className="space-y-4">
                                <div className={classNames.borderLeft}>
                                    ...
                                    <p className={classNames.textDefault}>Nucl. Instrum. Methods Phys. Res. A, 170239 (2025)</p>
                                    <p className={classNames.textDefault}>DOI: <a href="https://doi.org/10.1016/j.nima.2025.170239" className={classNames.textLink}>10.1016/j.nima.2025.170239</a></p>
                                </div>
                                <div className={classNames.borderLeft}>
                                    <h4 className={classNames.heading4}>β-delayed neutron emissions from N&gt;50 gallium isotopes</h4>
                                    <p className={classNames.textDefault}>Authors: R. Yokoyama et al.</p>
